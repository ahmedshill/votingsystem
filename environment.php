...
$sql_check ="select * from checks where admission='$adm' and post='male_hostels' ";
...
<div class="container">
    ...
    <div class="row justify-content-center">
        ...
        $sql="select * from candidates where position='male_hostels'";
...
if(isset($_POST['submit']))
{
    ...
    if(mysqli_num_rows($results)==0)
    {
        ...
        if($query){
            $today=date("Y-m-d");
            $sql_save="INSERT INTO `checks`(`id`, `admission`, `post`, `date_voted`) VALUES (null,'$adm','male_hostels','$today')";
